...
import { getParfum, getParfums, getAllParfums, getFilteredParfums, createParfum, updateParfum, deleteParfum, getExportParfumData } from '../controllers/parfum.controller.js';
...
router.get('/api/parfums/export', getExportParfumData);
