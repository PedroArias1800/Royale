...
export const FRONTEND_URL_LOCAL = process.env.FRONTEND_URL_LOCAL || "http://localhost:4173";
export const FRONTEND_URL_DOMAIN_CERTIFICATE = process.env.FRONTEND_URL_DOMAIN_CERTIFICATE || "http://localhost:4173";
...
export const ADMIN_URL_LOCAL = process.env.ADMIN_URL_LOCAL || "http://localhost:4174";
export const ADMIN_URL_DOMAIN_CERTIFICATE = process.env.ADMIN_URL_DOMAIN_CERTIFICATE || "http://localhost:4174";
