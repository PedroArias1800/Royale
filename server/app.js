...
import { FRONTEND_URL, ADMIN_URL, FRONTEND_URL_DOMAIN, FRONTEND_URL_DOMAIN_WWW } from './config.js';
...
app.use(cors({
    origin: [FRONTEND_URL, ADMIN_URL, FRONTEND_URL_DOMAIN, FRONTEND_URL_DOMAIN_WWW],
    credentials: true,
}));
app.use(morgan('dev'));
